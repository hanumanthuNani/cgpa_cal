...
form.addEventListener('submit', (e) => {
    ...
    for (let i = 1; i <= semesters; i++) {
        ...
        semesterInput.innerHTML = `
            ...
            <input type="number" id="courses-${i}" class="border border-gray-300 p-2 mb-2 w-full" min="1" required>
...
function addCourse(semester) {
    ...
    for (let i = 1; i <= numCourses; i++) {
        ...
        courseInput.innerHTML = `
            ...
            <input type="number" required class="border border-gray-300 p-2 w-full mb-2" min="1">
    ...
    for (let i = 0; i < grades.length; i++) {
        ...
        switch (grade.grade) {
            ...
            case 'D':
                ...
                break;
            case 'E':
                totalGradePoints += grade.credits * 0;
                break;
        }
    }
